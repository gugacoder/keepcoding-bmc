...
const STATUS_CONFIG: Record<string, { label: string; className: string }> = {
  ...
  pronto:     { label: 'Pronto',    className: 'bg-blue-100 text-blue-700' },
  aprovado:   { label: 'Pronto',    className: 'bg-blue-100 text-blue-700' },
        ...
        {!isPublished && (
          <div className="flex gap-2 pt-1">
            {!isReady && (
              <button
                onClick={onApprove}
                className="flex-1 flex items-center justify-center gap-1.5 text-xs font-medium text-blue-600 border border-blue-200 rounded-lg py-1.5 hover:bg-blue-50 transition-colors"
              >
            ...
            <button
              onClick={onPublish}
              className="flex-1 flex items-center justify-center gap-1.5 text-xs font-medium text-green-600 border border-green-200 rounded-lg py-1.5 hover:bg-green-50 transition-colors"
            >
